...
const registrationEmailField = document.querySelector(
    "#registrationEmailField"
);
const registrationEmailFeedBackArea = document.querySelector(
    ".registrationEmailFeedBackArea"
);
...
const formValidationFeedBack = document.querySelector(
...
const handleToggleInputOne = (e) => {
    if (
        showPasswordToggleOne.className ===
        "showPasswordToggleOne password-control view"
    ) {
...
const handleToggleInputTwo = (e) => {
    if (
        showPasswordToggleTwo.className ===
        "showPasswordToggleTwo password-control view"
    ) {
...
let validEmail = function () {
    ...
    let registrationEmailField = document.querySelector(
        "#registrationEmailField"
    );
    let registrationEmailFeedBackArea = document.querySelector(
        ".registrationEmailFeedBackArea"
    );
...
let validPassword = function () {
    ...
    if (passwordOneVal == "" || passwordTwoVal == "") {
        ...
        if (passwordOneVal != passwordTwoVal) {
            ...
            passwordOneVal === passwordTwoVal &&
            passwordOneVal.length >= 6
        ) {
...
let validCheck = function () {
    ...
    let formValidationFeedBack = document.querySelector(
        ".formValidationFeedBack"
    );
...
loginSubmit.onclick = (e) => {
    ...
    let loginEmailFeedBackArea = document.querySelector(
        ".loginEmailFeedBackArea"
    );
    let loginPasswordFeedBackArea = document.querySelector(
        ".loginPasswordFeedBackArea"
    );
